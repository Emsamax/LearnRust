...
pub(crate) fn car_arrived(floor: i32) -> Event {
    Event::CarArrived(floor)
}

/// The car doors have opened.
pub(crate) fn car_door_opened() -> Event {
    Event::CarDoorOpened
}

/// The car doors have closed.
pub(crate) fn car_door_closed() -> Event {
    Event::CarDoorClosed
}

/// A directional button was pressed in an elevator lobby on the given floor.
pub(crate) fn lobby_call_button_pressed(floor: i32, dir: Direction) -> Event {
    Event::ButtonPressed(Button::LobbyCall(dir, floor))
}

/// A floor button was pressed in the elevator car.
pub(crate) fn car_floor_button_pressed(floor: i32) -> Event {
